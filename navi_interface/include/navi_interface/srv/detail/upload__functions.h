...
#ifndef NAVI_INTERFACE__SRV__DETAIL__UPLOAD__FUNCTIONS_H_
#define NAVI_INTERFACE__SRV__DETAIL__UPLOAD__FUNCTIONS_H_
...
#include "navi_interface/msg/rosidl_generator_c__visibility_control.h"

#include "navi_interface/srv/detail/upload__struct.h"

/// Initialize srv/Upload message.
/**
...
/// Create srv/Upload message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * navi_interface__srv__Upload_Request__init().
...
/// Destroy srv/Upload message.
/**
 * It calls
 * navi_interface__srv__Upload_Request__fini()
...
/// Check for srv/Upload message equality.
/**
...
/// Initialize array of srv/Upload messages.
/**
...
/// Finalize array of srv/Upload messages.
/**
 * It calls
 * navi_interface__srv__Upload_Request__fini()
...
/// Create array of srv/Upload messages.
/**
 * It allocates the memory for the array and calls
 * navi_interface__srv__Upload_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/Upload messages.
/**
 * It calls
 * navi_interface__srv__Upload_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/Upload message array equality.
/**
...
/// Copy an array of srv/Upload messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * navi_interface__srv__Upload_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_navi_interface
...
/**
 * It calls
 * navi_interface__srv__Upload_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_navi_interface
...
/**
 * It allocates the memory for the array and calls
 * navi_interface__srv__Upload_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_navi_interface
...
/**
 * It calls
 * navi_interface__srv__Upload_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // NAVI_INTERFACE__SRV__DETAIL__UPLOAD__FUNCTIONS_H_
