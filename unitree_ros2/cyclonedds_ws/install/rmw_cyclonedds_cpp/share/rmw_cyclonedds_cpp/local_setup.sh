...
: ${AMENT_CURRENT_PREFIX:="/home/galbot/unitree_ros2/cyclonedds_ws/install/rmw_cyclonedds_cpp"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rmw_cyclonedds_cpp/environment/library_path.sh"
