...
static rosidl_typesupport_introspection_c__MessageMember LowCmd__rosidl_typesupport_introspection_c__LowCmd_message_member_array[5] = {
  {
    "mode_pr",  // name
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, unitree_hg, msg, LowCmd)() {
  LowCmd__rosidl_typesupport_introspection_c__LowCmd_message_member_array[2].members_ =
